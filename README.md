...
| 版本            | 日期            | 发布人          | 更新内容
| --------------- | --------------- | --------------- | ---------------
| 1.1.5.11_beta   | 2018-03-08      | 陆亚辉          | 合并自动配置功能
| 1.1.5.11_alpha  | 2018-02-07      | 张邺            | 再次改进惯导机制
| 1.1.5.10_beta   | 2018-01-27      | 勾泓钢          | 改进贝氏本地规划
| 1.1.5.10_alpha  | 2018-01-20      | 陆亚辉          | 加入贝氏本地规划
| 1.1.5.9_beta    | 2018-01-19      | 潘力澜          | 加入地图转换
| 1.1.5.9_alpha   | 2018-01-12      | 秦伟明          | 改进调度机制
| 1.1.5.8_beta    | 2017-12-15      | 秦伟明          | 修改测试通过；调试单车及调度
| 1.1.5.8_alpha   | 2017-12-14      | 陆亚辉          | 增加调度上位机界面；优化站点叉货
| 1.1.5.7_beta    | 2017-12-10      | 陆亚辉          | 增加上位机全局命名空间设置；改进站点灵活设置机制
| 1.1.5.7_alpha   | 2017-12-05      | 秦伟明          | 增加全局命名空间设置
| 1.1.5.6_beta    | 2017-12-03      | 张邺            | 全面增加叉车定位和导航稳定性
| 1.1.5.6_alpha   | 2017-12-02      | 张邺            | 改进imu功能
| 1.1.5.5_beta    | 2017-11-07      | 勾泓钢          | 调整叉车路点参数
| 1.1.5.5_alpha   | 2017-10-27      | 勾泓钢          | 加入本地规划算法；完善终段到达机制
| 1.1.5.4_beta    | 2017-10-24      | 勾泓钢          | 调整叉车参数；新增双激光型号；改进终段到达机制
| 1.1.5.4_alpha   | 2017-10-23      | 张邺            | 新增终段到达机制
| 1.1.5.3_beta    | 2017-10-11      | 韩立芹          | 改进固定路径规划；改进路点巡航策略；修改导航关键参数
| 1.1.5.3_alpha   | 2017-09-16      | 秦伟明          | 新增调度任务框架
| 1.1.5.2_beta    | 2017-09-15      | 勾泓钢          | 修改速度发布脚本；改进固定路径目标点转向机制；调试叉车参数
| 1.1.5.2_alpha   | 2017-09-14      | 潘力澜          | 加入托盘识别；加入路径服务
| 1.1.5.1_beta    | 2017-09-13      | 陆亚辉          | 解决tf网络性能；改写shell编译机制；更新tofflon和forklift参数
| 1.1.5.1_alpha   | 2017-09-05      | 韩立芹          | 加入scan_unifier包；改写shell压缩机制
| 1.1.5.0_beta    | 2017-09-04      | 张邺            | 重新启用js压缩机制
| 1.1.5.0_alpha   | 2017-09-02      | 陆亚辉          | 更新上位机界面
| 1.1.4.9_beta    | 2017-09-01      | 勾泓钢          | 调试叉车参数
| 1.1.4.9_alpha   | 2017-08-31      | 潘力澜          | 加入path_recorder包；加入fixed_global_planner包
| 1.1.4.8_beta    | 2017-08-10      | 张邺            | 撤销守护进程；修改waypoints/scan_marker/driver细节
| 1.1.4.8_alpha   | 2017-08-05      | 张邺            | 新增守护进程
| 1.1.4.7_beta    | 2017-08-04      | 张邺            | 修改scan_marker及scan_rectifier逻辑；修改叉车相关程序
| 1.1.4.7_alpha   | 2017-07-28      | 张邺            | 更新git检测；修改waypoints_navi逻辑
| 1.1.4.6_beta    | 2017-07-27      | 韩立芹          | 更新hrg3参数
...
| 1.1.4.4_alpha   | 2017-07-17      | 张邺            | 增加网络自适应脚本；移动bash脚本结构
| 1.1.4.3_beta    | 2017-07-14      | 仇隽挺          | 调整叉车导航参数
| 1.1.4.3_alpha   | 2017-07-12      | 仇隽挺          | 并入叉车相关文件
...
| 1.1.3.17_beta   | 2017-02-24      | 张邺            | 增加comm-ttys修复usb预配置问题
| 1.1.3.16_alpha  | 2017-02-23      | 张邺            | 增加waypoint的LOOP；增加comm-reset功能
| 1.1.3.15_alpha  | 2017-02-15      | 张邺            | 增加will2ssh型号；修复dbparam问题
| 1.1.3.14_alpha  | 2017-01-20      | 张邺            | 调试侧向雷达
| 1.1.3.13_beta   | 2017-01-17      | 陆亚辉          | 增加node_module以及js压缩功能
...
| 1.1.3.9_beta    | 2017-01-03      | 张邺            | 更新will2并发保存地图问题
| 1.1.3.8_alpha   | 2016-12-29      | 张邺            | 同步各个文档；加入ar_tool包；加入yujin_ocs包
...
| 1.1.3.2_beta    | 2016-12-13      | 张邺            | 更新整理了html代码；完善了与will2的代码兼容性和自动更新问题
...
| 1.1.1.5_beta    | 2016-08-29      | 仇隽挺          | 恢复到了原来膨胀层的版本，修改gmapping_pose逻辑
| 1.1.1.4_beta    | 2016-08-11      | 韩立芹          | 修改move_base中的recovery_behaviour机制；修改imu的timeout问题
| 1.1.1.3_beta    | 2016-06-23      | 仇隽挺          | 修改gmapping_pose逻辑，更改robot_pose_ekf位置
...
| 1.1.0.1_alpha   | 2016-05-05      | 张邺            | 改进了clear_costmaps/map/version功能
