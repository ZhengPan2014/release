...
struct StatusCode_
{
  ...
  (void)_alloc;
    ...
    enum { OK = 0u };
     enum { CANCELLED = 1u };
     enum { UNKNOWN = 2u };
     enum { INVALID_ARGUMENT = 3u };
     enum { DEADLINE_EXCEEDED = 4u };
     enum { NOT_FOUND = 5u };
     enum { ALREADY_EXISTS = 6u };
     enum { PERMISSION_DENIED = 7u };
     enum { RESOURCE_EXHAUSTED = 8u };
     enum { FAILED_PRECONDITION = 9u };
     enum { ABORTED = 10u };
     enum { OUT_OF_RANGE = 11u };
     enum { UNIMPLEMENTED = 12u };
     enum { INTERNAL = 13u };
     enum { UNAVAILABLE = 14u };
     enum { DATA_LOSS = 15u };
...
// {'std_msgs': ['/opt/ros/indigo/share/std_msgs/cmake/../msg'], 'cartographer_ros_msgs': ['/home/ouiyeah/workspaces/hitrobot/cartographer/src/cartographer_ros/cartographer_ros_msgs/msg'], 'geometry_msgs': ['/opt/ros/indigo/share/geometry_msgs/cmake/../msg']}
