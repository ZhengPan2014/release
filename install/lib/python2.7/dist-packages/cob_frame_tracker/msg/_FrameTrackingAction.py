...
"""autogenerated by genpy from cob_frame_tracker/FrameTrackingAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import cob_frame_tracker.msg
import geometry_msgs.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class FrameTrackingAction(genpy.Message):
  _md5sum = "16582ddc5d15eb6f94e19f890cd956ff"
  _type = "cob_frame_tracker/FrameTrackingAction"
...
float64 z"""
  ...
  _slot_types = ['cob_frame_tracker/FrameTrackingActionGoal','cob_frame_tracker/FrameTrackingActionResult','cob_frame_tracker/FrameTrackingActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FrameTrackingAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cob_frame_tracker.msg.FrameTrackingActionGoal()
      if self.action_result is None:
        self.action_result = cob_frame_tracker.msg.FrameTrackingActionResult()
      if self.action_feedback is None:
        self.action_feedback = cob_frame_tracker.msg.FrameTrackingActionFeedback()
    else:
      self.action_goal = cob_frame_tracker.msg.FrameTrackingActionGoal()
      self.action_result = cob_frame_tracker.msg.FrameTrackingActionResult()
      self.action_feedback = cob_frame_tracker.msg.FrameTrackingActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.tracking_frame
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_dB3I.pack(_x.action_goal.goal.tracking_duration, _x.action_goal.goal.stop_on_goal, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d.pack(_x.action_feedback.feedback.twist.linear.x, _x.action_feedback.feedback.twist.linear.y, _x.action_feedback.feedback.twist.linear.z, _x.action_feedback.feedback.twist.angular.x, _x.action_feedback.feedback.twist.angular.y, _x.action_feedback.feedback.twist.angular.z, _x.action_feedback.feedback.distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.tracking_frame = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.tracking_frame = str[start:end]
      _x = self
      start = end
      end += 21
      (_x.action_goal.goal.tracking_duration, _x.action_goal.goal.stop_on_goal, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_dB3I.unpack(str[start:end])
      self.action_goal.goal.stop_on_goal = bool(self.action_goal.goal.stop_on_goal)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.twist.linear.x, _x.action_feedback.feedback.twist.linear.y, _x.action_feedback.feedback.twist.linear.z, _x.action_feedback.feedback.twist.angular.x, _x.action_feedback.feedback.twist.angular.y, _x.action_feedback.feedback.twist.angular.z, _x.action_feedback.feedback.distance,) = _struct_7d.unpack(str[start:end])
      return self
