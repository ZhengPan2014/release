...
"""autogenerated by genpy from cob_frame_tracker/FrameTrackingActionResult.msg. Do not edit."""
import sys
...
class FrameTrackingActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "cob_frame_tracker/FrameTrackingActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_frame_tracker/FrameTrackingResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FrameTrackingActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_frame_tracker.msg.FrameTrackingResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_frame_tracker.msg.FrameTrackingResult()
