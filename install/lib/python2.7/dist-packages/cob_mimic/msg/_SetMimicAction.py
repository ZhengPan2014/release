...
"""autogenerated by genpy from cob_mimic/SetMimicAction.msg. Do not edit."""
import sys
...
class SetMimicAction(genpy.Message):
  _md5sum = "bcce0cdfbf604e56a24465f9095fb580"
  _type = "cob_mimic/SetMimicAction"
...
"""
  ...
  _slot_types = ['cob_mimic/SetMimicActionGoal','cob_mimic/SetMimicActionResult','cob_mimic/SetMimicActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetMimicAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cob_mimic.msg.SetMimicActionGoal()
      if self.action_result is None:
        self.action_result = cob_mimic.msg.SetMimicActionResult()
      if self.action_feedback is None:
        self.action_feedback = cob_mimic.msg.SetMimicActionFeedback()
    else:
      self.action_goal = cob_mimic.msg.SetMimicActionGoal()
      self.action_result = cob_mimic.msg.SetMimicActionResult()
      self.action_feedback = cob_mimic.msg.SetMimicActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.mimic
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_fq3I.pack(_x.action_goal.goal.speed, _x.action_goal.goal.repeat, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.mimic = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.mimic = str[start:end]
      _x = self
      start = end
      end += 24
      (_x.action_goal.goal.speed, _x.action_goal.goal.repeat, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_fq3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
