...
"""autogenerated by genpy from cob_mimic/SetMimicActionResult.msg. Do not edit."""
import sys
...
class SetMimicActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "cob_mimic/SetMimicActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_mimic/SetMimicResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetMimicActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_mimic.msg.SetMimicResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_mimic.msg.SetMimicResult()
