...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_8d.pack(_x.center.x, _x.center.y, _x.center.z, _x.velocity.x, _x.velocity.y, _x.velocity.z, _x.radius, _x.true_radius))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.center.x, _x.center.y, _x.center.z, _x.velocity.x, _x.velocity.y, _x.velocity.z, _x.radius, _x.true_radius,) = _struct_8d.unpack(str[start:end])
      return self
