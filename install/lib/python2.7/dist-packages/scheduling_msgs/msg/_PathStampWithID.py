...
"""autogenerated by genpy from scheduling_msgs/PathStampWithID.msg. Do not edit."""
import sys
...
class PathStampWithID(genpy.Message):
  _md5sum = "cdd7203384a2fc9ee858c81f1710e608"
  _type = "scheduling_msgs/PathStampWithID"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,priority,pathID,flags,poses
    ...
    """
    if args or kwds:
      super(PathStampWithID, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3i.pack(_x.priority, _x.pathID, _x.flags))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.priority, _x.pathID, _x.flags,) = _struct_3i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.poses = []
