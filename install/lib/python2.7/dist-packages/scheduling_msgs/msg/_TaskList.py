...
"""autogenerated by genpy from scheduling_msgs/TaskList.msg. Do not edit."""
import sys
    ...
    try:
      ...
      for val1 in self.tasks:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        _x = val1
        buff.write(_struct_2i.pack(_x.taskID, _x.agvID))
        _x = val1.agvName
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.taskID, _x.agvID,) = _struct_2i.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
