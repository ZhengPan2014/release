...
"""autogenerated by genpy from scheduling_msgs/TaskQueryAndGainPathRequest.msg. Do not edit."""
import sys
...
class TaskQueryAndGainPathRequest(genpy.Message):
  _md5sum = "051e458a398225d76b01053a55bd73ff"
  _type = "scheduling_msgs/TaskQueryAndGainPathRequest"
...
float64 w
"""
  __slots__ = ['header','agvID','agvPos','goalPos']
  _slot_types = ['std_msgs/Header','int32','geometry_msgs/PoseStamped','geometry_msgs/PoseStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TaskQueryAndGainPathRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_i3I.pack(_x.agvID, _x.agvPos.header.seq, _x.agvPos.header.stamp.secs, _x.agvPos.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.agvID, _x.agvPos.header.seq, _x.agvPos.header.stamp.secs, _x.agvPos.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from scheduling_msgs/TaskQueryAndGainPathResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class TaskQueryAndGainPathResponse(genpy.Message):
  _md5sum = "feaac5dc93963716c141bd4b89eb4e7e"
  _type = "scheduling_msgs/TaskQueryAndGainPathResponse"
...
float64 theta"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TaskQueryAndGainPathResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_B.pack(self.isValid))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.isValid,) = _struct_B.unpack(str[start:end])
...
class TaskQueryAndGainPath(object):
  _type          = 'scheduling_msgs/TaskQueryAndGainPath'
  _md5sum = '2558b785b45a88b34b4d9ecdb1d64193'
  _request_class  = TaskQueryAndGainPathRequest
  _response_class = TaskQueryAndGainPathResponse
