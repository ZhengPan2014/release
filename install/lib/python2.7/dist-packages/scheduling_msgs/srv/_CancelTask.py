...
"""autogenerated by genpy from scheduling_msgs/CancelTaskRequest.msg. Do not edit."""
import sys
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from scheduling_msgs/CancelTaskResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class CancelTaskResponse(genpy.Message):
  _md5sum = "49ceb5b32ea3af22073ede4a0328249e"
  _type = "scheduling_msgs/CancelTaskResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CancelTaskResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
