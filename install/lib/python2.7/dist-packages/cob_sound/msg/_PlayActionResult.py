...
"""autogenerated by genpy from cob_sound/PlayActionResult.msg. Do not edit."""
import sys
...
class PlayActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "cob_sound/PlayActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_sound/PlayResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlayActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_sound.msg.PlayResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_sound.msg.PlayResult()
