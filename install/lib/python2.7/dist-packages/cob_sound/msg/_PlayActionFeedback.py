...
"""autogenerated by genpy from cob_sound/PlayActionFeedback.msg. Do not edit."""
import sys
...
class PlayActionFeedback(genpy.Message):
  _md5sum = "8e6a85b455e340bc166129c1c7b60477"
  _type = "cob_sound/PlayActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_sound/PlayFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlayActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cob_sound.msg.PlayFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cob_sound.msg.PlayFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_fq.pack(_x.feedback.position, _x.feedback.time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.position, _x.feedback.time,) = _struct_fq.unpack(str[start:end])
      return self
