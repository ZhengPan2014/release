...
class SetLightModeActionResult(genpy.Message):
  _md5sum = "a7cd182f60109a44b6340140e075e94e"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2BQ.pack(_x.result.active_mode, _x.result.active_priority, _x.result.track_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.active_mode, _x.result.active_priority, _x.result.track_id,) = _struct_2BQ.unpack(str[start:end])
      return self
