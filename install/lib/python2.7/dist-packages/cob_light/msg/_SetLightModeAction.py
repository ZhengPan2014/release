...
class SetLightModeAction(genpy.Message):
  _md5sum = "2794c0820a6aed117a1f67676120d5fa"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B2fib.pack(_x.action_goal.goal.mode.mode, _x.action_goal.goal.mode.frequency, _x.action_goal.goal.mode.timeout, _x.action_goal.goal.mode.pulses, _x.action_goal.goal.mode.priority))
      length = len(self.action_goal.goal.mode.colors)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.mode.colors:
        _x = val1
        buff.write(_struct_4f.pack(_x.r, _x.g, _x.b, _x.a))
      length = len(self.action_goal.goal.mode.sequences)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.mode.sequences:
        _v1 = val1.color
        _x = _v1
        buff.write(_struct_4f.pack(_x.r, _x.g, _x.b, _x.a))
        _x = val1
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2BQ3I.pack(_x.action_result.result.active_mode, _x.action_result.result.active_priority, _x.action_result.result.track_id, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.mode.mode, _x.action_goal.goal.mode.frequency, _x.action_goal.goal.mode.timeout, _x.action_goal.goal.mode.pulses, _x.action_goal.goal.mode.priority,) = _struct_B2fib.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.mode.colors = []
      for i in range(0, length):
        ...
        self.action_goal.goal.mode.colors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.mode.sequences = []
      for i in range(0, length):
        ...
        self.action_goal.goal.mode.sequences.append(val1)
      _x = self
      start = end
      end += 12
      ...
      (_x.action_result.result.active_mode, _x.action_result.result.active_priority, _x.action_result.result.track_id, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_2BQ3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
