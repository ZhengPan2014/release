...
if("FALSE" STREQUAL "TRUE")
  ...
  set(depth_calibration_INSTALL_PREFIX /home/ouiyeah/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'depth_calibration' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'hitrobot <hitrobot@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'depth_calibration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ouiyeah/catkin_ws/install/${idir}'.  Ask the maintainer 'hitrobot <hitrobot@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${depth_calibration_dep}_FOUND)
      find_package(${depth_calibration_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${depth_calibration_dep} REQUIRED ${depend_list})
  endif()
