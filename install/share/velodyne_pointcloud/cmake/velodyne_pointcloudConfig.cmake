...
if("FALSE" STREQUAL "TRUE")
  set(velodyne_pointcloud_SOURCE_PREFIX /home/ouiyeah/catkin_ws/src/velodyne/velodyne_pointcloud)
  set(velodyne_pointcloud_DEVEL_PREFIX /home/ouiyeah/catkin_ws/devel)
  ...
  set(velodyne_pointcloud_INSTALL_PREFIX /home/ouiyeah/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ouiyeah/catkin_ws/install/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>' to fix it.")
    endif()
    _list_append_unique(velodyne_pointcloud_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "velodyne_rawdata;yaml-cpp")
