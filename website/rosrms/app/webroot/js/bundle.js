...
class Workspace {
    ...
    _initWorkspace() {
        ...
        new widget_1.Widget(wg.id, "Topic Subscriber", "TopicSubscriber", "../js/widgets/topic_subscriber");
        new widget_1.Widget(wg.id, "Topic Publisher", "TopicPublisher", "../js/widgets/topic_publisher");
        new widget_1.Widget(wg.id, "Param Viewer", "ParamViewer", "../js/widgets/param_viewer");
        new widget_1.Widget(wg.id, "Service Viewer", "ServiceViewer", "../js/widgets/service_viewer");
        new widget_1.Widget(wg.id, "ActionLib Tool", "ActionLibTool", "../js/widgets/action_lib_tool");
        wg = new widget_group_1.WidgetGroup("Sensors");
        new widget_1.Widget(wg.id, "Google Maps GPS Viewer", "GoogleMapsGpsViewer", "../js/widgets/gmaps_gps");
        new widget_1.Widget(wg.id, "Camera Viewer", "CameraViewer", "../js/widgets/camera_viewer");
        new widget_1.Widget(wg.id, "Laser Scan Viewer", "LaserScanViewer", "../js/widgets/laser_scan_viewer");
        new widget_1.Widget(wg.id, "IMU Viewer", "ImuViewer", "../js/widgets/imu_viewer");
        wg = new widget_group_1.WidgetGroup("3D Viewer");
        new widget_1.Widget(wg.id, "ROS 3D Viewer", "ROS3DViewer", "../js/widgets/ros_3d_viewer");
        wg = new widget_group_1.WidgetGroup("Diagnostics");
        new widget_1.Widget(wg.id, "Diagnostics Viewer", "DiagnosticsViewer", "../js/widgets/diagnostics_viewer");
        new widget_1.Widget(wg.id, "Log reader", "LogReader", "../js/widgets/log_reader");
        wg = new widget_group_1.WidgetGroup("Development");
        new widget_1.Widget(wg.id, "New Widget", "NewWidget", "../js/widgets/new_widget");
    }
    _clearWorkspace() {
...
class Frontend {
    ...
    newWidget(widget) {
        ...
        $("#footer").after("<script type='text/javascript' src='" + widget.url.slice(2) + "/main.js'></script>");
    }
