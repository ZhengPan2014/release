...
function init() {
    $(document).ready(function () {
        $("#jsRosUrl").val("ws://10.1.16.249:9090");
...
class Workspace {
    ...
    _initWorkspace() {
        ...
        new widget_1.Widget(wg.id, "Topic Subscriber", "TopicSubscriber", "../js/rosweb/src/widgets/topic_subscriber");
        new widget_1.Widget(wg.id, "Topic Publisher", "TopicPublisher", "../js/rosweb/src/widgets/topic_publisher");
        new widget_1.Widget(wg.id, "Param Viewer", "ParamViewer", "../js/rosweb/src/widgets/param_viewer");
        new widget_1.Widget(wg.id, "Service Viewer", "ServiceViewer", "../js/rosweb/src/widgets/service_viewer");
        new widget_1.Widget(wg.id, "ActionLib Tool", "ActionLibTool", "../js/rosweb/src/widgets/action_lib_tool");
        wg = new widget_group_1.WidgetGroup("Sensors");
        new widget_1.Widget(wg.id, "Google Maps GPS Viewer", "GoogleMapsGpsViewer", "../js/rosweb/src/widgets/gmaps_gps");
        new widget_1.Widget(wg.id, "Camera Viewer", "CameraViewer", "../js/rosweb/src/widgets/camera_viewer");
        new widget_1.Widget(wg.id, "Laser Scan Viewer", "LaserScanViewer", "../js/rosweb/src/widgets/laser_scan_viewer");
        new widget_1.Widget(wg.id, "IMU Viewer", "ImuViewer", "../js/rosweb/src/widgets/imu_viewer");
        wg = new widget_group_1.WidgetGroup("3D Viewer");
        new widget_1.Widget(wg.id, "ROS 3D Viewer", "ROS3DViewer", "../js/rosweb/src/widgets/ros_3d_viewer");
        wg = new widget_group_1.WidgetGroup("Diagnostics");
        new widget_1.Widget(wg.id, "Diagnostics Viewer", "DiagnosticsViewer", "../js/rosweb/src/widgets/diagnostics_viewer");
        new widget_1.Widget(wg.id, "Log reader", "LogReader", "../js/rosweb/src/widgets/log_reader");
        wg = new widget_group_1.WidgetGroup("Development");
        new widget_1.Widget(wg.id, "New Widget", "NewWidget", "../js/rosweb/src/widgets/new_widget");
    }
    _clearWorkspace() {
