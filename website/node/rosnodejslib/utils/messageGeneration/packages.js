...
exports.getAllPackages = function(done) {
  ...
  async.reduce(directories, [], function(memo, directory, callback) {
    ...
    directories.forEach(function(directory) {
      ...
      var packageNameLowerCase = packageName.toLowerCase();
      if (cache.hasOwnProperty(packageNameLowerCase))
      {
          // grayloo
          // use pkgs in catkin_ws
          if (cache[packageNameLowerCase].startsWith('/home'))
          {
            return;
          }
      }
      cache[packageNameLowerCase] = directory;
    });
