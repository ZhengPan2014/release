 ...
 *   * pulse (optional) - if the marker should "pulse" over time
 */
ROS2D.NavigationPath = function (options) {
    console.log(options);
    ...
    this.graphics.moveTo(1.3, -0.1);
    for (var i = 1; i < 2; i++) {
        this.graphics.lineTo(1.25, -0.094);
    }
    this.graphics.endStroke();
    createjs.Shape.call(this, this.graphics);

}
ROS2D.NavigationPath.prototype.__proto__ = createjs.Shape.prototype;
